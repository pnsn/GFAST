...
StartUpDelay  0                # seconds to wait before playing 1st file
ScreenMsg     1                # (optional) if non-zero, informational messages will be
                               #   written to the screen as data is played
SendLate      60.0             # (optional) if present, packets will be
...
#WaveFile      playback/20190706_ridgecrest6_GNSS_SEIS.01.tnk
#WaveFile      playback/ridgecrest_gps.tnk
WaveFile      playback/ridgecrest_gps_60.tnk
