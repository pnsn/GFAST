                      ...
                      double *M, double *VR)
{
    ...
    *M = 0.0;
    ...
    G  = GFAST_memory_calloc__double(n*1);
    b  = GFAST_memory_calloc__double(n);
    ...
    // Apply weights
    WG = GFAST_memory_calloc__double(n*1);
    Wb = GFAST_memory_calloc__double(n);
    #pragma omp simd
    for (i=0; i<n; i++){
    ...
    UP = GFAST_memory_calloc__double(n);
